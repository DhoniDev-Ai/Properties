            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
                ...
                <div className="flex flex-col md:flex-row justify-between items-end mb-16 gap-8">
                    <div className="max-w-2xl">
                        <h3 className="text-sm font-black text-blue-400 uppercase tracking-[0.2em] mb-4">Professional Division</h3>
                    ...
                    <div className="flex items-center gap-6">
                         ...
                         <div className="w-12 h-12 rounded-full border-2 border-blue-500 overflow-hidden shrink-0">
                             <img src="https://images.unsplash.com/photo-1560250097-0b93528c311a?auto=format&fit=crop&w=100&q=80" alt="Anil Goyal" />
                         </div>
                    </div>
                </div>

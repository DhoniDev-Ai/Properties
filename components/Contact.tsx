                ...
                <div className="flex flex-col lg:flex-row gap-10 lg:gap-16">
                            ...
                            <div className="space-y-8">
                                ...
                                <div className="flex items-start group">
                                    ...
                                    <div className="pt-2">
                                        ...
                                        <p className="text-slate-600 text-base">Mon - Sat: 9:00 AM - 9:00 PM</p>
                    ...
                    <div className="flex-1 flex flex-col space-y-8">
                        ...
                        <div className="w-full h-full min-h-[450px] bg-slate-200 rounded-3xl overflow-hidden border border-slate-100 relative shadow-sm">
                            <iframe
                                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d113941.01160867807!2d75.71960144686948!3d26.885346580982363!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x396c4adf4c57e281%3A0xce1c63a0cf22e09!2sJaipur%2C%20Rajasthan!5e0!3m2!1sen!2sin!4v1709121960010!5m2!1sen!2sin"
                                width="100%"
                                height="100%"
                                style={{ border: 0 }}

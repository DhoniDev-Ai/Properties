            ...
            <div className="flex border-b border-slate-200 mb-8 overflow-x-auto scrollbar-hide">
                {tabs.map((tab) => (
                    <button
                        ...
                        className={`px-6 py-4 flex items-center gap-2 font-bold whitespace-nowrap transition-all border-b-2 ${activeTab === tab.id
            ...
            <div className="bg-white">
                    ...
                    <>
                        {property.amenities && property.amenities.length > 0 ? (
                            ...
                            <div className="flex flex-col items-center justify-center py-12 px-4 bg-slate-50/50 rounded-2xl border border-dashed border-slate-200">
                                ...
                                <span className="text-slate-500 font-bold text-center">No standard amenities listed for this property.</span>
                            </div>
                        )}
                    </>
                )}
                ...
                {activeTab === "location" && (
                    <div className="rounded-2xl overflow-hidden shadow-sm border border-slate-200">
                        ...
                        <div className="h-[300px] bg-slate-100 flex items-center justify-center flex-col text-slate-400 p-8 text-center">
                            <MapPin className="w-12 h-10 mb-2 opacity-50" />
                            ...
                            {property.location.googleMapLink ? (
                                <a
                                    ...
                                    className=" mt-3 px-6 py-2 bg-[#1D4ED8] text-white rounded-lg border border-slate-200 font-bold shadow-sm hover:bg-blue-800 transition-all"
                                >
                                    View on Google Maps
                                </a>
                            ) : (
                                <div className="mt-3 px-6 py-2 bg-white rounded-lg border border-slate-200 text-[#1D4ED8] font-bold shadow-sm">
                        ...
                        <div className="space-y-6">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                                ...
                                <div className="bg-white rounded-2xl p-6 shadow-sm border border-blue-50 flex flex-col justify-center text-center">
                                    ...
                                    <a href={`tel:${8426022000}`} className="mt-6 py-2.5 px-6 bg-[#1D4ED8] text-white rounded-xl cursor-pointer font-bold text-sm shadow-md hover:bg-blue-800 transition-all">
                                        Get Loan Assistance
                                    </a>
                                </div>
                            </div>

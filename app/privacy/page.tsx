...
export const metadata = {
    title: "Privacy Policy | Agrwal Properties",
    description: "Privacy policy and data protection practices for Agrwal Properties Jaipur.",
};
            ...
            <section className="pt-32 pb-20 bg-slate-50">
                <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="prose prose-slate max-w-none text-slate-600 space-y-6 text-lg leading-relaxed">
                        ...
                        <p>
                            At Agrwal Properties, reachable from agrwalproperties.com, one of our main priorities is the privacy of our visitors. This Privacy Policy document contains types of information that is collected and recorded by Agrwal Properties and how we use it.
                        </p>
